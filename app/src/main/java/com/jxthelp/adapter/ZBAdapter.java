...
public class ZBAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return NewsRequest.ZBNewsList.size();
    }

    @Override
    public Object getItem(int position) {
        return NewsRequest.ZBNewsList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        News news = NewsRequest.ZBNewsList.get(position);
    ...
    public void upDate(final Listener listener) {
        NewsRequest.request(App.ZBPAGE, new Listener() {
            @Override
            public void onStart() {
        ...
        System.out.println("count:-----------" + App.ZBPAGE);
    }
}
