...
public class MTAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return NewsRequest.MTNewsList.size();
    }

    @Override
    public Object getItem(int position) {
        return NewsRequest.MTNewsList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        News news = NewsRequest.MTNewsList.get(position);
    ...
    public void upDate(final Listener listener) {
        NewsRequest.request(App.MTPAGE, new Listener() {
            @Override
            public void onStart() {
        ...
        System.out.println("count:-----------" + App.MTPAGE);
    }
}
