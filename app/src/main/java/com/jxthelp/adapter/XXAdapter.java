...
public class XXAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return NewsRequest.XXNewsList.size();
    }

    @Override
    public Object getItem(int position) {
        return NewsRequest.XXNewsList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        News news = NewsRequest.XXNewsList.get(position);
    ...
    public void upDate(final Listener listener) {
        NewsRequest.request(App.XXPAGE, new Listener() {
            @Override
            public void onStart() {
        ...
        System.out.println("count:-----------" + App.XXPAGE);
    }
}
