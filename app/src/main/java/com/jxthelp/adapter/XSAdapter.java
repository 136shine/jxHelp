...
public class XSAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return NewsRequest.XSNewsList.size();
    }

    @Override
    public Object getItem(int position) {
        return NewsRequest.XSNewsList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        News news = NewsRequest.XSNewsList.get(position);
    ...
    public void upDate(final Listener listener) {
        NewsRequest.request(App.XSPAGE, new Listener() {
            @Override
            public void onStart() {
        ...
        System.out.println("count:-----------" + App.XSPAGE);
    }
}
