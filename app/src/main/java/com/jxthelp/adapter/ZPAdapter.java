...
public class ZPAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return NewsRequest.ZPNewsList.size();
    }

    @Override
    public Object getItem(int position) {
        return NewsRequest.ZPNewsList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        News news = NewsRequest.ZPNewsList.get(position);
    ...
    public void upDate(final Listener listener) {
        NewsRequest.request(App.ZPPAGE, new Listener() {
            @Override
            public void onStart() {
        ...
        System.out.println("count:-----------" + App.ZPPAGE);
    }
}
